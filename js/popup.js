...
function renderOption(option) {
    var _a;
    return option ? react_1.default.createElement(ConfigTitle, { name: option.text, status: ((_a = option.data) === null || _a === void 0 ? void 0 : _a.active) && 'Activo' }) : null;
}
    ...
    return (react_2.default.createElement("div", null,
        react_2.default.createElement("div", { className: "global-prefs-body" },
            react_2.default.createElement("section", null,
                react_2.default.createElement("h3", null, "Preferencias"),
                react_2.default.createElement(react_1.Checkbox, { label: "Mostrar control de la hoja de atajos superpuesto", checked: prefs.showControlsOverlay, onChange: handleChange, title: "Mostrar una superposición con todas las fijaciones de botones visibles durante el juego" })),
            react_2.default.createElement(react_1.Separator, null),
            react_2.default.createElement(ShortcutCommandsList_1.default, null)),
        react_2.default.createElement(react_1.PrimaryButton, { iconProps: backIcon, onClick: goBack, style: { position: 'absolute', bottom: 0 } }, "Atrás")));
}
            ...
            react_1.default.createElement("div", { className: "horizontal centered" },
                react_1.default.createElement("div", { className: "vertical centered-v left-aligned margin-right" },
                    react_1.default.createElement("div", { className: "overflow-ellipsis" },
                        react_1.default.createElement("small", null, "Jugando con:"),
                        " ",
...
function SensitivitySelector({ dispatch, disabled, readOnly, sensitivity }) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(react_2.SpinButton, { label: "Sensibilidad del mouse (1-99)", className: (0, classnames_1.default)(readOnly && 'no-pointer-events'), labelPosition: react_2.Position.top, disabled: disabled, onChange: readOnly ? undefined : handleChange, value: disabled ? 'N/A' : (100 - sensitivity).toString(), min: 1, max: 99 }),
        react_1.default.createElement("small", null, "Es posible que deba configurar la sensibilidad en la configuración del juego también (así como apagar cualquier \"deadzone\" opción en el juego).")));
}
    ...
    return (react_2.default.createElement("section", null,
        ...
        !commands ? (react_2.default.createElement(react_1.Shimmer, null)) : (react_2.default.createElement("div", null,
            ...
            react_2.default.createElement(react_1.Link, { href: "#", underline: true, onClick: () => chrome.tabs.create({
                ...
                }) }, "Cambiar en la página de extensiones...")))));
}
...
function StickSelector({ disabled, stick, onChange, readOnly }) {
    ...
    return (react_1.default.createElement(react_2.ChoiceGroup, { className: (0, classnames_1.default)(readOnly && 'no-pointer-events'), disabled: disabled, label: "¿Qué stick analógico moverá el movimiento del mouse?", selectedKey: stick === 0 ? '0' : stick === 1 ? '1' : '-1', onChange: readOnly ? undefined : handleChange, options: options }));
}
