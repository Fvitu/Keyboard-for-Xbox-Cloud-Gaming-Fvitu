...
exports.firstClickText = 'Haga clic aquí para habilitar el control del mouse';
exports.secondClickText = 'Haga clic nuevamente para habilitar el mouse';
...
function OnboardingIntro({ onDismiss }) {
    ...
    return (react_1.default.createElement(react_responsive_modal_1.Modal, { center: true, open: true, onClose: onDismiss, showCloseIcon: false, focusTrapped: true, closeOnEsc: false, closeOnOverlayClick: false },
        react_1.default.createElement("div", { className: "explanation-modal-xmnk" },
            react_1.default.createElement("h1", null, "¡Bienvenido a Teclado y mouse para Xbox Clodu Gaming creado por Fvitu!"),
            react_1.default.createElement("p", null,
                react_1.default.createElement("strong", null, "Use la ventana emergente de la extensión para configurar sus atajos para las teclas.")),
            react_1.default.createElement("p", null,
                "Para acceder a la ventana emergente de extensión, simplemente haga clic en el ",
                react_1.default.createElement("img", { src: icon16 }),
                " ícono en la parte superior derecha de su navegador.Si no ves el ",
                react_1.default.createElement("img", { src: icon16 }),
                " ícono en su barra de herramientas de extensión, use los siguientes pasos para sujetarlo:"),
            react_1.default.createElement("ol", null,
                react_1.default.createElement("li", null, "Haga clic en el ícono del rompecabezas de extensiones en la parte superior derecha de la barra de herramientas del navegador"),
                react_1.default.createElement("li", null, "Haga clic en el icono de pin junto al icono rojo del mouse Xcloud")),
            react_1.default.createElement("p", null,
                react_1.default.createElement("strong", null, "Otras notas importantes:")),
            react_1.default.createElement("ul", null,
                react_1.default.createElement("li", null, "Puede ver una advertencia al lanzar un juego en XCloud sobre que no se ha encontrado un mando para jugar; solo haga click en \"Continúa de todos modos\""),
                react_1.default.createElement("li", null,
                    "El control del mouse se puede habilitar haciendo clic en la superposición que aparece después de iniciar un juego, y se puede salir presionando la tecla ",
                    react_1.default.createElement("kbd", null, "Esc"),
                    ""),
                react_1.default.createElement("li", null,
                    "La sensibilidad del mouse se puede cambiar en la ventana emergente de extensión, sin embargo, para obtener los mejores resultados.",
                    ' ',
                    react_1.default.createElement("u", null, "También es importante ajustar la sensibilidad del stick del controlador y las opciones de zona muerta dentro de la configuración de cada juego también"))),
